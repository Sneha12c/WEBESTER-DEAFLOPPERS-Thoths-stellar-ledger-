const Promptforextractingdata = `
You are an AI assistant that extracts structured data from documents. 
For the given document (PDF or image or excelsheet), extract the following information and return it in JSON format:
...
module.exports = {Promptforextractingdata};